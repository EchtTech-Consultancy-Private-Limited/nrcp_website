                  ...
                  <div class="cont_secsns left_dhr mob-item2">
                     ...
                     <div class="main_btntop_chnges">
                        ...
                        <div class="new_btns_cols" >
                           ...
                           <button class="button-29 text-center " role="button"> <a href="#" class="blink_text" data-toggle="modal" data-target="#vaccination">
                     ...
                     <div class="notice-bord style1">
                        ...
                        <div class="marquee marquee-vertical" data-speed="50">
                           <div class="marquee-wrapper">
                              ...
                              <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab1 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                              <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab2 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                              <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab3 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                              <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab4 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                              <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab5 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                                 <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab6 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                                 <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-hand-o-right mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab7 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="marquee marquee-vertical" data-speed="50">
                           <div class="marquee-wrapper">
                              ...
                              <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-circle-thin mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab1 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
                                 <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-circle-thin mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                 ...
                                 <div class="latest-lists">
                                   <a href=""><strong><i class="fa fa-circle-thin mx-1"  aria-hidden="true"></i> : </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint eos quisquam unde nisi. Illo
                                    ut dolor ea amet. Cum reiciendis ab8 <img src="{{ asset('Nrcp_img/gifs/new-gif-new.gif') }}" alt=""></a>
                                 </div>
