         ...
         <div class="col-md-6 text-lg-right pl-0">
            <ul class="toolbar-sl-share rs-inner-blog d-flex align-items-center justify-content-between">
               ...
               @if ($social_media->facebook != '')
                   <li>
                       <a href="{{ url($social_media->facebook) }}" @if (Session::get('Lang') == 'en') onclick="return confirm('This link will take you to an external web site.')"  @else onclick="return confirm('यह लिंक आपको एक बाहरी वेब साइट पर ले जाएगा।')" @endif target="_blank" title="Facebook" rel="noopener noreferrer">
               ...
               @if ($social_media->twitter != '')
                   <li>
                       <a href="{{ url($social_media->twitter) }}" @if (Session::get('Lang') == 'en') onclick="return confirm('This link will take you to an external web site.')"  @else onclick="return confirm('यह लिंक आपको एक बाहरी वेब साइट पर ले जाएगा।')" @endif  target="_blank" title="Twitter" rel="noopener noreferrer">
                           <img src="{{ asset('assets/Nrcp_img/twitter-logo.png') }}" alt="Twitter Logo" class="twitter-logo-top">
                       </a>
                   </li>
               @endif
           @endif
