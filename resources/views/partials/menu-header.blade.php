            ...
            <div class="main-menu">
               ...
               <nav class="rs-menu">
                  <ul class="nav-menu">
                     ...
                     <li class="menu-item-has-children">
                        <a href="javascript:void();" class="main-anchor"> Publications</a>
                        <ul class="sub-menu">
                     ...
                     <li class="menu-item-has-children multi-menu">
                        <a href="javascript:void();" class="main-anchor"> Downloads</a>
                        <ul class="sub-menu">
                           <li class="menu-item-has-children">
                              <a href="javascript:void();">Committees</a>
                              <ul class="sub-menu">
                                 <li class="menu-item-has-children">
                                    <a href="javascript:void(0);" target="_blank" class="main-anchor"> Documents –
                                    SOPs</a>
                                    <ul class="sub-menu">
                           ...
                           <li>
                              <a href="javascript:void(0);" target="_blank" class="main-anchor"> Reporting Format</a>
                              <ul class="sub-menu">
                     ...
                     <li class="float-right"><a href="https://dev.nrcpdashboard.staggings.in/public/"
